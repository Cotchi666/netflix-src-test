...
import {
  ...
  addProfile,
  setCurrentProfile,
} from "../../redux/Profile/actions/profileAction";
...
const HomeTest = () => {
  ...
  return (
    <div className={styles.full}>
      <Link to="/browse" className={styles.logo}></Link>
        ...
        <div className={styles.box}>
          ...
          <div>
            <div onClick={handleOpen} className={styles.addprofile}>
              <AddCircleIcon
                style={{ fontSize: "100px", color: "grey", marginTop: "20px" }}
              />{" "}
            </div>
            <div onClick={handleOpen} className={styles.profilename}>
              {" "}
              Add Profile{" "}
            </div>
            <Modal isOpen={open} style={customStyles} ariaHideApp={false}>
              ...
              <div className={styles.btns}>
                <button onClick={handleAddProfile} className={styles.cont}>
                  CONTINUE
                </button>
